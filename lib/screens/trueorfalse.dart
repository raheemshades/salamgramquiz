                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: truefalse.trueorfalseans == true
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: const Color.fromRGBO(0, 168, 241, 1)),
                          color: truefalse.trueorfalseans == false
                              ? const Color.fromRGBO(0, 168, 241, 1)
                              : Colors.white,
                        ),
                        child: Center(
                ...
                InkWell(
                  onTap: () {
                    truefalse.answers.addAll({
                      truefalse.truefalse[truefalse.count - 1].id:
                          truefalse.trueorfalseans
                    });
